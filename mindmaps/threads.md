  ...
  root((Threads))
    Advantages over "one process per client" architecture
        ...
        Problems with the "fork" function
            The fork function creates a new process duplicating the full state of its parent
    ...
    Multiple architectures can be used when working with threads
        Worker pool architecture
            ...
            Queueing is used when the number of request is greater than the number of threads
